...
LIST_URL = f"{URL}/api/sro/all/member/list"
MEMBER_URL = f'{URL}/api/member/19495169/info'
HEADERS = {
...
async def get_card_data(_id):
    return_data = {}
    _url = f'https://reestr.nopriz.ru/api/member/{_id}/info'
...
async def get_page_info(page_number):
    ...
    response = await post(LIST_URL, headers=HEADERS, json=body)
